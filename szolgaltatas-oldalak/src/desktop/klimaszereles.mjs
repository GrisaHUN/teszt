// Klímaszerelés, DESKTOP blokk (801 px-tól). Szöveg: src/tartalom/klimaszereles.mjs
export default (c, h) => {
  const ar = h.ar(c.ar);
  return `
<section class="__P__hero" aria-labelledby="__P__h1">
<div class="__P__hero-media">${h.hero(c.hero.desktop, c.hero.alt, '(max-width: 800px)')}</div>
<div class="__P__wrap __P__hero-inner">
<div class="__P__hero-box">
<h1 id="__P__h1" class="__P__h1 __P__rv __P__up">${c.hero.h1}</h1>
<div class="__P__btns __P__rv __P__up" style="--__P__d:120ms">
${h.zoho(c.cta)}
${h.tel()}
</div>
</div>
...
<section class="__P__sec __P__intro">
...
<section class="__P__sec __P__sec-gray __P__steps" aria-labelledby="__P__steps-h">
<div class="__P__wrap">
<h2 id="__P__steps-h" class="__P__h2 __P__center __P__rv __P__up">${c.lepesekCim}</h2>
<ol class="__P__steps-grid">
${c.lepesek.map((s, i) => `<li class="__P__step __P__card __P__host __P__rv __P__up" style="--__P__d:${(i % 3) * 110}ms">
...
<section class="__P__sec __P__pricing">
<div class="__P__wrap __P__pricing-grid">
<p class="__P__lead __P__pricing-text __P__rv __P__up">${c.arMagyarazat}</p>
...
<section class="__P__sec __P__sec-gray __P__faq" aria-labelledby="__P__faq-h">
...
<div><h3 class="__P__qa-q">${f.q}</h3><p class="__P__qa-a">${h.md(f.a)}</p></div>
</div>`).join('\n')}
</div>
</div>
${h.wave('#0E1C43')}
